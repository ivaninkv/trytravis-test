...
* Попробовали разные подходы в организации кода в плейбуках:
...
* Заменили провижионеры в `packer` на `ansible` вместо `shell`. Собрали новые образы и проверили работоспособность плейбуков на новых образах.
